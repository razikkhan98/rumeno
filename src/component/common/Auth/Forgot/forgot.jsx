                        ...
                        <div className="col-lg-6 p-5">
                            <div className="form container px-5">
                                <div className="text-center">
                                    <span className="text-uppercase font-size-24">Forgot Password?</span>
                                    <p className="text-color-orange">No Worries, We help you set a new password</p>
                                    <p>Enter your registered E-mail ID/ Mobile no and we will send you a verification code</p>
                                </div>
