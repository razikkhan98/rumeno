        ...
        <div className="bg-light-orange-color row g-0 form-radius">
          <div className="col-lg-6 p-5  text-white form-img">
            ...
            <div>
              ...
              <p className="font-size-18">
                Reach us anytime by simply filling this basic form
              </p>
            </div>
          </div>
          <div className="col-lg-6 container d-flex align-items-center">
            <form className="row px-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-3 d-flex flex-column col-lg-12">
                <label className="form-label">
                  Size of the land for animal farming
                </label>
                <div>
                  <input
                    {...register("farmType")}
                    ...
                    id="goat"
                  />
                  <label htmlFor="goat" className="ms-2 me-5">
                    Goat
                  </label>
                  <input
                    {...register("farmType")}
                    ...
                    id="sheep"
                  />
                  <label htmlFor="sheep" className="ms-2 me-5">
                    Sheep
                  </label>
                  <input
                    {...register("farmType")}
                    ...
                    id="cow"
                  />
                  <label htmlFor="cow" className="ms-2 me-5">
                    Cow
                  </label>
                  <input
                    {...register("farmType")}
                    ...
                    id="buffalo"
                  />
                  <label htmlFor="buffalo" className="ms-2">
                    Buffalo
                  </label>
                </div>
              </div>
              ...
              <button
                type="submit"
                className="btn py-3 mt-3 text-white w-100 bg-orange-color"
              >
                Submit
              </button>
            </form>
