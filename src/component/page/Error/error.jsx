...
const ErrorPage = () => {
  return (
    <>
      <div className="error-bg-color d-flex flex-column align-items-center justify-content-center">
        <div className="d-flex align-items-end">
          <img src={ErrorImg} className="error-img" alt="Loading" />
          <img src={Cow} className="error-cow ms-lg-5" alt="Loading" />
        </div>
        <NavLink to={"/"}>
          <button className="btn error-btn px-4 py-2 text-white text-uppercase mt-4">
            Go Home
          </button>
        </NavLink>
      </div>
